...
The interface can convert itself to standard `rlang` with the help of an RStudio addin that replaces `friendlyeval` functions with their `rlang` equivalents. This will allow you to prototype in friendly, the subsequently automagically transform to `rlang`. Your friends won't know the difference.
